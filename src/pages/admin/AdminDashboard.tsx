...
import { useState, useEffect } from 'react';
import { Book, ShoppingBag, DollarSign, TrendingUp, Menu } from 'lucide-react';
import { AdminSidebar } from '@/components/layout/AdminSidebar';
import { booksApi, ordersApi, Book as BookType, Order } from '@/lib/api';
...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Sidebar */}
      <div
        className={`fixed z-50 h-full w-64 transform bg-background transition-transform duration-300 md:translate-x-0 ${
